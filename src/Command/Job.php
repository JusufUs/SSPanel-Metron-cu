...
class Job extends Command
{
    ...
    public function DailyJob()
    {
        ...
        // 重置节点流量
        Node::whereIn('sort', [0, 10, 11, 12, 13, 14, 15])
    ...
    {
        if (MetronSetting::get('auto_close_ticket') === true) {
            ...
            foreach ($tickets as $ticket) {
                ...
                $time = MetronSetting::get('close_ticket_time') * 86400;
        ...
        if (MetronSetting::get('del_user_ticket') === true) {
