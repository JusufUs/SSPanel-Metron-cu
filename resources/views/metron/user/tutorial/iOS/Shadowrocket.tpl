                                                    ...
                                                    <p class="font-size-h1 pb-5"><strong>1. 通过 App Store 安装客户端</strong></p>
                                                        {if $user->class >= $metron['ios_class']}
                                                            <div class="input-group mb-3 col-md-8 col-lg-8">
                                                                <input type="text" class="form-control" value="{$apple_id[0]}" disabled="disabled">
                                                                <div class="input-group-append">
                                                                    <button class="btn btn-primary copy-text" type="button" data-clipboard-text="{$apple_id[0]}">复制账号</button>
                                                                </div>
                                                            </div>
                                                            <div class="input-group mb-3 col-md-8 col-lg-8">
                                                                <input type="text" class="form-control" value="{$apple_id[1]}" disabled="disabled">
                                                                <div class="input-group-append">
                                                                    <button class="btn btn-primary copy-text" type="button" data-clipboard-text="{$apple_id[1]}">复制密码</button>
                                                                </div>
                                                            </div>
                                                            <div class="input-group mb-3 col-md-8 col-lg-8">
                                                                <input type="text" class="form-control" value="{$apple_id[2]}" disabled="disabled">
                                                            </div>
